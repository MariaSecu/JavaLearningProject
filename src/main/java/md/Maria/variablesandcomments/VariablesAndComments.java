package md.Maria.variablesandcomments;

public class VariablesAndComments {
    public static void main(String[] args) {

        //Declare the primitive data type variables
        boolean falseBooleanVariables;
        boolean trueBooleanVariables;
        ...
        lowerLimitOfIntDataType = 2147483647;
        ...
        System.out.println(trueBooleanVariables);
